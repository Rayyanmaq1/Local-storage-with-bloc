...
class SavedUpcomingMoviesUseCase implements UseCase<void, ResultsEntity> {
  final UpcomingMoviesRepository _moviesRepository;
  SavedUpcomingMoviesUseCase(this._moviesRepository);
  @override
  Future<void> call({ResultsEntity? params}) {
    return _moviesRepository.saveUpcomingMoviesLocal(params!);
  }
}
